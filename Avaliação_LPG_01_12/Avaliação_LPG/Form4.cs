...
namespace Avaliação_LPG
{
    public partial class Form4 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string querry = "INSERT INTO servico(`Nome`, `Preco`) VALUES ('" + textBox1.Text + "', '" + textBox2.Text + "')";
        ...
        {
            string connectionString = "datasource=127.0.0.1;port=3306;username=root;password=;database=petshop;";
            string query = "UPDATE `servico` SET `nome` = '" + textBox1.Text + "', `preco` = '" + textBox2.Text + "' WHERE id = '" + textBox5.Text + "'";
        ...
        {
            string connectionString = "datasource=127.0.0.1;port=3306;username=root;password=;database=petshop;";
            string query = "DELETE FROM `servico` WHERE id = '" + textBox5.Text + "' ";
        ...
        {
            string connectionString = "datasource=127.0.0.1;port=3306;username=root;password=;database=petshop;";
            string query = "SELECT * FROM servico WHERE nome LIKE '" + textBox4.Text + "%'";
